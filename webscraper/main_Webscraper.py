...
def RequestRide(url):
    ...
    driver.find_element(By.XPATH, "//input[@type='email']").send_keys("speedsayssuii")
    ...
    driver.refresh()
    driver.find_element(By.XPATH, "//input[@name='password']").send_keys("smokeweedeveryday")
    driver.find_element(By.XPATH, "//span[text()='Next']").click()
    ...
    while True:
        ...
        try:
            ...
            # )
            # check_label.click()
            print("HIHIHIHIHIHHIHIHIHIHIHIHIHIHIHIHIHIHIHIHIHIHI")
            continue
